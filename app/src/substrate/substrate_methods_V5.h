...
#define PD_CALL_ASSETS_CREATE_V5 0
typedef struct {
    pd_Compactu32_t id;
    pd_LookupasStaticLookupSource_V5_t admin;
    pd_Balance_t min_balance;
} pd_assets_create_V5_t;
...
#define PD_CALL_ASSETS_DESTROY_V5 2
typedef struct {
    pd_Compactu32_t id;
    pd_DestroyWitness_V5_t witness;
} pd_assets_destroy_V5_t;
...
typedef union {
    ...
    pd_assets_create_V5_t assets_create_V5;
    pd_assets_force_create_V5_t assets_force_create_V5;
    pd_assets_destroy_V5_t assets_destroy_V5;
