...
#define PD_CALL_COLLATORSELECTION_V8 21
#define PD_CALL_SESSION_V8 22
#define PD_CALL_XCMPQUEUE_V8 30
#define PD_CALL_DMPQUEUE_V8 33
#define PD_CALL_UTILITY_V8 40
#define PD_CALL_MULTISIG_V8 41
#define PD_CALL_PROXY_V8 42
#define PD_CALL_ASSETS_V8 50
#define PD_CALL_UNIQUES_V8 51

#define PD_CALL_BALANCES_TRANSFER_ALL_V8 4
typedef struct {
    pd_AccountIdLookupOfT_V8_t dest;
...
#define PD_CALL_XCMPQUEUE_SERVICE_OVERWEIGHT_V8 0
typedef struct {
    pd_OverweightIndex_V8_t index;
    pd_Weight_V8_t weight_limit;
} pd_xcmpqueue_service_overweight_V8_t;

#define PD_CALL_XCMPQUEUE_SUSPEND_XCM_EXECUTION_V8 1
typedef struct {
} pd_xcmpqueue_suspend_xcm_execution_V8_t;

#define PD_CALL_XCMPQUEUE_RESUME_XCM_EXECUTION_V8 2
typedef struct {
} pd_xcmpqueue_resume_xcm_execution_V8_t;

#define PD_CALL_XCMPQUEUE_UPDATE_SUSPEND_THRESHOLD_V8 3
typedef struct {
    pd_u32_t new_;
} pd_xcmpqueue_update_suspend_threshold_V8_t;

#define PD_CALL_XCMPQUEUE_UPDATE_DROP_THRESHOLD_V8 4
typedef struct {
    pd_u32_t new_;
} pd_xcmpqueue_update_drop_threshold_V8_t;

#define PD_CALL_XCMPQUEUE_UPDATE_RESUME_THRESHOLD_V8 5
typedef struct {
    pd_u32_t new_;
} pd_xcmpqueue_update_resume_threshold_V8_t;

#define PD_CALL_XCMPQUEUE_UPDATE_THRESHOLD_WEIGHT_V8 6
typedef struct {
    pd_Weight_V8_t new_;
} pd_xcmpqueue_update_threshold_weight_V8_t;

#define PD_CALL_XCMPQUEUE_UPDATE_WEIGHT_RESTRICT_DECAY_V8 7
typedef struct {
    pd_Weight_V8_t new_;
} pd_xcmpqueue_update_weight_restrict_decay_V8_t;

#define PD_CALL_XCMPQUEUE_UPDATE_XCMP_MAX_INDIVIDUAL_WEIGHT_V8 8
typedef struct {
    pd_Weight_V8_t new_;
} pd_xcmpqueue_update_xcmp_max_individual_weight_V8_t;

#define PD_CALL_DMPQUEUE_SERVICE_OVERWEIGHT_V8 0
typedef struct {
    pd_OverweightIndex_V8_t index;
    pd_Weight_V8_t weight_limit;
} pd_dmpqueue_service_overweight_V8_t;

#define PD_CALL_PROXY_ADD_PROXY_V8 1
typedef struct {
    pd_AccountIdLookupOfT_V8_t delegate;
...
typedef struct {
    pd_AccountIdLookupOfT_V8_t spawner;
    pd_ProxyType_V8_t proxy_type;
    pd_u16_t index;
...
typedef struct {
    pd_AccountIdLookupOfT_V8_t real;
...
#define PD_CALL_ASSETS_TOUCH_V8 23
typedef struct {
    pd_Compactu32_t id;
} pd_assets_touch_V8_t;

#define PD_CALL_ASSETS_REFUND_V8 24
typedef struct {
    pd_Compactu32_t id;
    pd_bool_t allow_burn;
} pd_assets_refund_V8_t;

#define PD_CALL_UNIQUES_CREATE_V8 0
typedef struct {
    pd_CollectionId_V8_t collection;
    pd_AccountIdLookupOfT_V8_t admin;
} pd_uniques_create_V8_t;

#define PD_CALL_UNIQUES_FORCE_CREATE_V8 1
typedef struct {
    pd_CollectionId_V8_t collection;
    pd_AccountIdLookupOfT_V8_t owner;
...
typedef struct {
    pd_CollectionId_V8_t collection;
    pd_DestroyWitness_V8_t witness;
...
typedef struct {
    pd_CollectionId_V8_t collection;
    pd_ItemId_V8_t item;
    pd_OptionAccountIdLookupOfT_V8_t check_owner;
...
typedef struct {
    pd_CollectionId_V8_t collection;
    pd_AccountIdLookupOfT_V8_t issuer;
    pd_AccountIdLookupOfT_V8_t admin;
    pd_AccountIdLookupOfT_V8_t freezer;
...
typedef struct {
    pd_CollectionId_V8_t collection;
    pd_ItemId_V8_t item;
    pd_OptionAccountIdLookupOfT_V8_t maybe_check_delegate;
...
typedef struct {
    pd_CollectionId_V8_t collection;
    pd_OptionItemId_V8_t maybe_item;
    pd_BoundedVecu8_V8_t key;
    pd_BoundedVecu8_V8_t value;
...
typedef struct {
    pd_OptionCollectionId_V8_t maybe_collection;
...
typedef struct {
    pd_CollectionId_V8_t collection;
    pd_ItemId_V8_t item;
    pd_OptionItemPrice_V8_t price;
    pd_OptionAccountIdLookupOfT_V8_t whitelisted_buyer;
...
typedef union {
    ...
    pd_xcmpqueue_service_overweight_V8_t xcmpqueue_service_overweight_V8;
    pd_xcmpqueue_suspend_xcm_execution_V8_t xcmpqueue_suspend_xcm_execution_V8;
    pd_xcmpqueue_resume_xcm_execution_V8_t xcmpqueue_resume_xcm_execution_V8;
    pd_xcmpqueue_update_suspend_threshold_V8_t xcmpqueue_update_suspend_threshold_V8;
    pd_xcmpqueue_update_drop_threshold_V8_t xcmpqueue_update_drop_threshold_V8;
    pd_xcmpqueue_update_resume_threshold_V8_t xcmpqueue_update_resume_threshold_V8;
    pd_xcmpqueue_update_threshold_weight_V8_t xcmpqueue_update_threshold_weight_V8;
    pd_xcmpqueue_update_weight_restrict_decay_V8_t xcmpqueue_update_weight_restrict_decay_V8;
    pd_xcmpqueue_update_xcmp_max_individual_weight_V8_t xcmpqueue_update_xcmp_max_individual_weight_V8;
    pd_dmpqueue_service_overweight_V8_t dmpqueue_service_overweight_V8;
    ...
    pd_assets_touch_V8_t assets_touch_V8;
    pd_assets_refund_V8_t assets_refund_V8;
...
typedef struct {
    pd_AccountIdLookupOfT_V8_t source;
    pd_AccountIdLookupOfT_V8_t dest;
    pd_CompactBalance_t amount;
...
#define PD_CALL_ASSETS_CREATE_V8 0
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t admin;
    pd_Balance_t min_balance;
} pd_assets_create_V8_t;

#define PD_CALL_ASSETS_FORCE_CREATE_V8 1
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t owner;
    pd_bool_t is_sufficient;
    pd_Compactu128_t min_balance;
} pd_assets_force_create_V8_t;

#define PD_CALL_ASSETS_DESTROY_V8 2
typedef struct {
    pd_Compactu32_t id;
    pd_DestroyWitness_V8_t witness;
} pd_assets_destroy_V8_t;

#define PD_CALL_ASSETS_MINT_V8 3
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t beneficiary;
    pd_Compactu128_t amount;
} pd_assets_mint_V8_t;

#define PD_CALL_ASSETS_BURN_V8 4
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t who;
    pd_Compactu128_t amount;
...
#define PD_CALL_ASSETS_TRANSFER_V8 5
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t target;
    pd_Compactu128_t amount;
} pd_assets_transfer_V8_t;

#define PD_CALL_ASSETS_TRANSFER_KEEP_ALIVE_V8 6
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t target;
    pd_Compactu128_t amount;
} pd_assets_transfer_keep_alive_V8_t;

#define PD_CALL_ASSETS_FORCE_TRANSFER_V8 7
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t source;
    pd_AccountIdLookupOfT_V8_t dest;
    pd_Compactu128_t amount;
} pd_assets_force_transfer_V8_t;

#define PD_CALL_ASSETS_FREEZE_V8 8
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t who;
} pd_assets_freeze_V8_t;

#define PD_CALL_ASSETS_THAW_V8 9
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t who;
} pd_assets_thaw_V8_t;

#define PD_CALL_ASSETS_FREEZE_ASSET_V8 10
typedef struct {
    pd_Compactu32_t id;
} pd_assets_freeze_asset_V8_t;

#define PD_CALL_ASSETS_THAW_ASSET_V8 11
typedef struct {
    pd_Compactu32_t id;
} pd_assets_thaw_asset_V8_t;

#define PD_CALL_ASSETS_TRANSFER_OWNERSHIP_V8 12
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t owner;
} pd_assets_transfer_ownership_V8_t;

#define PD_CALL_ASSETS_SET_TEAM_V8 13
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t issuer;
    pd_AccountIdLookupOfT_V8_t admin;
    pd_AccountIdLookupOfT_V8_t freezer;
} pd_assets_set_team_V8_t;

#define PD_CALL_ASSETS_SET_METADATA_V8 14
typedef struct {
    pd_Compactu32_t id;
    pd_Vecu8_t name;
    pd_Vecu8_t symbol;
    pd_u8_t decimals;
} pd_assets_set_metadata_V8_t;

#define PD_CALL_ASSETS_CLEAR_METADATA_V8 15
typedef struct {
    pd_Compactu32_t id;
} pd_assets_clear_metadata_V8_t;

#define PD_CALL_ASSETS_FORCE_SET_METADATA_V8 16
typedef struct {
    pd_Compactu32_t id;
    pd_Vecu8_t name;
    pd_Vecu8_t symbol;
    pd_u8_t decimals;
    pd_bool_t is_frozen;
} pd_assets_force_set_metadata_V8_t;

#define PD_CALL_ASSETS_FORCE_CLEAR_METADATA_V8 17
typedef struct {
    pd_Compactu32_t id;
} pd_assets_force_clear_metadata_V8_t;

#define PD_CALL_ASSETS_FORCE_ASSET_STATUS_V8 18
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t owner;
    pd_AccountIdLookupOfT_V8_t issuer;
    ...
    pd_bool_t is_sufficient;
    pd_bool_t is_frozen;
} pd_assets_force_asset_status_V8_t;

#define PD_CALL_ASSETS_APPROVE_TRANSFER_V8 19
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t delegate;
    pd_Compactu128_t amount;
} pd_assets_approve_transfer_V8_t;

#define PD_CALL_ASSETS_CANCEL_APPROVAL_V8 20
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t delegate;
} pd_assets_cancel_approval_V8_t;

#define PD_CALL_ASSETS_FORCE_CANCEL_APPROVAL_V8 21
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t owner;
    pd_AccountIdLookupOfT_V8_t delegate;
} pd_assets_force_cancel_approval_V8_t;

#define PD_CALL_ASSETS_TRANSFER_APPROVED_V8 22
typedef struct {
    pd_Compactu32_t id;
    pd_AccountIdLookupOfT_V8_t owner;
    pd_AccountIdLookupOfT_V8_t destination;
    pd_Compactu128_t amount;
} pd_assets_transfer_approved_V8_t;
...
typedef union {
    ...
    pd_assets_create_V8_t assets_create_V8;
    pd_assets_force_create_V8_t assets_force_create_V8;
    pd_assets_destroy_V8_t assets_destroy_V8;
    pd_assets_mint_V8_t assets_mint_V8;
    pd_assets_burn_V8_t assets_burn_V8;
    pd_assets_transfer_V8_t assets_transfer_V8;
    pd_assets_transfer_keep_alive_V8_t assets_transfer_keep_alive_V8;
    pd_assets_force_transfer_V8_t assets_force_transfer_V8;
    pd_assets_freeze_V8_t assets_freeze_V8;
    pd_assets_thaw_V8_t assets_thaw_V8;
    pd_assets_freeze_asset_V8_t assets_freeze_asset_V8;
    pd_assets_thaw_asset_V8_t assets_thaw_asset_V8;
    pd_assets_transfer_ownership_V8_t assets_transfer_ownership_V8;
    pd_assets_set_team_V8_t assets_set_team_V8;
    pd_assets_set_metadata_V8_t assets_set_metadata_V8;
    pd_assets_clear_metadata_V8_t assets_clear_metadata_V8;
    pd_assets_force_set_metadata_V8_t assets_force_set_metadata_V8;
    pd_assets_force_clear_metadata_V8_t assets_force_clear_metadata_V8;
    pd_assets_force_asset_status_V8_t assets_force_asset_status_V8;
    pd_assets_approve_transfer_V8_t assets_approve_transfer_V8;
    pd_assets_cancel_approval_V8_t assets_cancel_approval_V8;
    pd_assets_force_cancel_approval_V8_t assets_force_cancel_approval_V8;
    pd_assets_transfer_approved_V8_t assets_transfer_approved_V8;
#endif
