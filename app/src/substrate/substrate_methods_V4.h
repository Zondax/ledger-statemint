...
#define PD_CALL_COLLATORSELECTION_SET_INVULNERABLES_V4 0
typedef struct {
    pd_VecAccountId_V4_t new_;
} pd_collatorselection_set_invulnerables_V4_t;
...
typedef union {
    ...
    pd_collatorselection_set_invulnerables_V4_t collatorselection_set_invulnerables_V4;
...
#define PD_CALL_ASSETS_CREATE_V4 0
typedef struct {
    pd_Compactu32_t id;
    pd_LookupasStaticLookupSource_V4_t admin;
    pd_Balance_t min_balance;
} pd_assets_create_V4_t;
...
#define PD_CALL_ASSETS_DESTROY_V4 2
typedef struct {
    pd_Compactu32_t id;
    pd_DestroyWitness_V4_t witness;
} pd_assets_destroy_V4_t;
...
typedef union {
    ...
    pd_assets_create_V4_t assets_create_V4;
    pd_assets_force_create_V4_t assets_force_create_V4;
    pd_assets_destroy_V4_t assets_destroy_V4;
