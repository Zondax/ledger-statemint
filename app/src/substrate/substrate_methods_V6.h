...
#define PD_CALL_ASSETS_CREATE_V6 0
typedef struct {
    pd_Compactu32_t id;
    pd_LookupasStaticLookupSource_V6_t admin;
    pd_Balance_t min_balance;
} pd_assets_create_V6_t;
...
#define PD_CALL_ASSETS_DESTROY_V6 2
typedef struct {
    pd_Compactu32_t id;
    pd_DestroyWitness_V6_t witness;
} pd_assets_destroy_V6_t;
...
typedef union {
    ...
    pd_assets_create_V6_t assets_create_V6;
    pd_assets_force_create_V6_t assets_force_create_V6;
    pd_assets_destroy_V6_t assets_destroy_V6;
